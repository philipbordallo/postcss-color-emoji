(() => {
  const EMOJI_LIST = [
    ...
    { name: 'hash', hex: '#&#8419;' },
    { name: 'astrick', hex: '*&#8419;' },
    { name: 'information source', hex: '&#x2139;' },
    { name: 'black rightwards arrow', hex: '&#x27A1;' },
    { name: 'double exclamation mark', hex: '&#x203C;' },
    { name: 'exclamation question mark', hex: '&#x2049;' },
    { name: 'circled latin capital letter m', hex: '&#x24C2;' },
    ...
    { name: 'heavy heart exclamation mark ornament', hex: '&#x2763;' },
    ...
    { name: 'no entry', hex: '&#x26D4;' },
    { name: 'part alternation mark', hex: '&#x303D;' },
    { name: 'pencil', hex: '&#x270F;' },
